...
fun SongItem1(song: Song1) {
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            if (song.name == "Sapphire") {
                Image(
                    painter = painterResource(id = R.drawable.saph),
                    contentDescription = "Sapphire Cover",
                    modifier = Modifier.fillMaxSize()
                        .size(180.dp)
                        .padding(end = 5.dp)
                )
            }
            if (song.name == "Kaala Chasma") {
                Image(
                    painter = painterResource(id = R.drawable.kala),
                    contentDescription = "Ghunghroo Cover",
                    modifier = Modifier.fillMaxSize()
                        .size(180.dp)
                        .padding(end = 5.dp)
                )
            }
            if(song.name=="Jalebi Baby"){
                Image(painterResource(id = R.drawable.jalebi),
                    contentDescription = "Jalebi Cover",
